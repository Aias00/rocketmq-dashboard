...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'settings.appearance': { zh: '界面偏好', en: 'Appearance' },
  ...
  'settings.securitySession': { zh: '安全与会话', en: 'Security and session' },
  'settings.sessionTimeout': { zh: '会话超时', en: 'Session timeout' },
  'settings.sessionTimeoutHelp': {
    zh: '应用于新创建的会话，已登录用户保持原到期时间',
    en: 'Applies to newly created sessions. Existing sessions keep their original expiry.',
  },
  ...
  'settings.dingtalkWebhookHelp': {
    ...
    en: 'Alert rules using the DingTalk channel send messages to this bot.',
  },
  ...
  'settings.smsWebhookHelp': {
    zh: '占位配置，短信发送通道后续接入',
    en: 'Placeholder configuration. The SMS delivery channel will be integrated later.',
  },
